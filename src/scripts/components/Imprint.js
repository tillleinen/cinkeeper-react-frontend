...
require('styles/Imprint.sass');

var Imprint = React.createClass({
  render: function () {
    return (
		<div className="imprint-container">
        	...
        	<div className="imprint__content">
				...
				<p>Kevin Domanski und Philip Herbort</p>

				<h2>Kontakt:</h2>
				<p>Telefon: +49 (0) 176 821 89544<br />
				Telefon: +49 (0) 176 327 64290<br />
				E-Mail: info@cinekeeper.de</p>

				<h2>Umsatzsteuer-ID:</h2>
				<p>Umsatzsteuer-Identifikationsnummer gem&auml;&szlig; &sect;27a<br />
				Umsatzsteuergesetz: DE299497354&nbsp;</p>

				<h2>Homepagedesign &amp; Programmierung:</h2>
				<p><a href="http://till.is" target="_blank">www.till.is</a></p>
